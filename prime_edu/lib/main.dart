...
void main() {
  runApp(const PrimeEduApp());
}

class PrimeEduApp extends StatelessWidget {
  const PrimeEduApp({super.key});
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (context) => AnnouncementProvider()..initialize(),
        ),
        ChangeNotifierProvider(create: (context) => BookDownloadProvider()),
        ChangeNotifierProvider(create: (context) => CalendarProvider()..initialize()),
      ],
      child: MaterialApp(
        title: 'Prime Edu',
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          AppColors.background, // Updated to use new background color
      body: Center(
        child: Column(
