...
class UserService {
  ...
  final List<UserModel> _users = [
    ...
    UserModel(
      ...
      email: 'carlos.oliveira@prime.edu',
      userType: UserType.teacher,
  ...
  List<UserModel> getStudentsByClass(String classId) {
    return _users
        .where(
          (user) =>
              user.userType == UserType.student && user.classId == classId,
        )
        .toList();
  }
