...
class _ProfileTabState extends State<ProfileTab> {
  ...
  Widget _buildUserInfo(UserModel user) {
    return Column(
      ...
      children: [
        ...
        _buildInfoCard([
          _buildInfoItem(icon: Icons.email, label: 'Email', value: user.email),
          _buildInfoItem(
            icon: Icons.badge,
  ...
  Widget _buildStudentAcademicInfo(UserModel user) {
    ...
    return _buildInfoCard([
      _buildInfoItem(icon: Icons.class_, label: 'Turma', value: '3º Ano A'),
      _buildInfoItem(
        icon: Icons.school,
        label: 'Matérias',
      ...
      _buildInfoItem(
        ...
        valueColor: stats['pendingAssignments'] > 0
            ? AppColors.warning
            : AppColors.success,
      ),
      _buildInfoItem(
