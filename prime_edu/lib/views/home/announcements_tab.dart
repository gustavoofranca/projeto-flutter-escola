...
class _AnnouncementsTabState extends State<AnnouncementsTab> {
  ...
  Widget _buildContent(user) {
    return Consumer<AnnouncementProvider>(
      builder: (context, announcementProvider, child) {
        ...
        // Apply filters
        if (_filterType != null) {
          announcements = announcementProvider.filterByType(
            announcements,
            _filterType!,
          );
        }
        if (_filterPriority != null) {
          announcements = announcementProvider.filterByPriority(
            announcements,
            _filterPriority!,
          );
        }
        ...
        if (_searchQuery.isNotEmpty) {
          announcements = announcementProvider.searchAnnouncements(
            announcements,
            _searchQuery,
          );
        }
  ...
  void _editAnnouncement(BuildContext context, AnnouncementModel announcement) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            CreateAnnouncementScreen(editingAnnouncement: announcement),
      ),
    );
  }
