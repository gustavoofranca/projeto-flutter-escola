...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingPage> _pages = [
    OnboardingPage(
      title: 'Bem-vindo ao Prime Edu',
      description:
          'A plataforma educacional mais inteligente e intuitiva para alunos e professores.',
      image: Icons.school,
    ...
    OnboardingPage(
      ...
      description:
          'Receba conteúdo adaptado ao seu ritmo de aprendizado e estilo de estudo.',
    ...
    OnboardingPage(
      ...
      description:
          'Mantenha-se conectado com professores e colegas através do chat integrado.',
    ...
    OnboardingPage(
      ...
      description:
          'Gerencie suas atividades, notas e calendário escolar em um só lugar.',
