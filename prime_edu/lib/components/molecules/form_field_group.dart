...
class _FormFieldGroupState extends State<FormFieldGroup> {
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonFormField<String>(
            ...
            onChanged: config.enabled == false
                ? null
                : config.onDropdownChanged,
  ...
  Widget _buildCheckboxField(FormFieldConfig config) {
    return Semantics(
      ...
      child: InkWell(
        onTap: config.enabled == false
            ? null
            : () {
                config.onCheckboxChanged?.call(
                  !(config.checkboxValue ?? false),
                );
              },
