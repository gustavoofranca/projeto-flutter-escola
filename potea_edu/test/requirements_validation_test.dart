...
import 'package:potea_edu/providers/auth_provider.dart';
import 'package:potea_edu/components/atoms/custom_button.dart';
import 'package:potea_edu/components/atoms/custom_text_field.dart';
import 'package:potea_edu/components/atoms/custom_typography.dart';
import 'package:potea_edu/components/molecules/info_card.dart';
import 'package:potea_edu/components/molecules/section_title.dart';
import 'package:potea_edu/services/api_service.dart';
import 'package:potea_edu/services/auth_service.dart';
import 'package:potea_edu/services/announcement_service.dart';
import 'package:potea_edu/models/user_model.dart';
import 'package:potea_edu/models/announcement_model.dart';

void main() {
  group('Potea Edu - Complete Requirements Validation', () {
    ...
    group('Atomic Design Components', () {
      testWidgets('CustomButton atom exists and works', (WidgetTester tester) async {
      ...
      testWidgets('CustomTextField atom exists and works', (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
      ...
      testWidgets('CustomTypography atom exists and works', (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(
              body: CustomTypography.h1(text: 'Test Typography'),
            ),
          ),
        );
      ...
      testWidgets('InfoCard molecule exists and works', (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
              body: InfoCard(
      ...
      testWidgets('SectionTitle molecule exists and works', (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(
              body: SectionTitle(
    ...
    group('Microinteractions and Accessibility', () {
      testWidgets('Components have Semantics for accessibility', (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
              body: CustomButton(
      ...
      testWidgets('Components have animations/microinteractions', (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
              body: CustomButton(
    ...
    group('Navigation and State Management', () {
      testWidgets('Bottom navigation has announcements instead of messages', (WidgetTester tester) async {
        await tester.pumpWidget(
          ChangeNotifierProvider(
            create: (_) => AuthProvider(),
            child: const PoteaEduApp(),
          ),
        );
