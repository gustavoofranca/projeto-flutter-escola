...
class _CreateAnnouncementScreenState extends State<CreateAnnouncementScreen> {
        ...
        children: [
            ...
            items: _availableClasses.map((className) {
              return DropdownMenuItem(
                ...
                child: Row(
                  children: [
                    Icon(
                      className == 'Todas as turmas' ? Icons.public : Icons.group,
          ...
          ListTile(
            ...
            trailing: IconButton(
              ...
              onPressed: _expiresAt != null ? _clearExpirationDate : _selectExpirationDate,
            ),
  ...
  Future<void> _saveAnnouncement() async {
    ...
    try {
      ...
      final announcement = AnnouncementModel(
        id: widget.editingAnnouncement?.id ?? DateTime.now().millisecondsSinceEpoch.toString(),
  ...
  Future<void> _deleteAnnouncement() async {
    ...
    try {
      final announcementProvider = context.read<AnnouncementProvider>();
      final success = await announcementProvider.deleteAnnouncement(widget.editingAnnouncement!.id);
